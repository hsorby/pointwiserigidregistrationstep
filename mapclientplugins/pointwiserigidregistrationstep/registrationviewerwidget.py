...
'''
from PySide.QtGui import QWidget, QAbstractItemView, QTableWidgetItem
...
from mapclientplugins.pointwiserigidregistrationstep.ui_registrationviewerwidget import Ui_RegistrationViewerWidget
...
class ZincDataPoints(object):

    def __init__(self, label, data, renderArgs=None):
        self._label = label
        self._data = data
        self._render_args = renderArgs
...
class RegistrationViewerWidget(QWidget):
    '''
    ...
    def __init__(self, sourceData, targetData, config, registerFunc, regMethods, parent=None):
        ...
        Constructor
        '''
        super(RegistrationViewerWidget, self).__init__(parent)
        self._ui = Ui_RegistrationViewerWidget()
    ...
    def _saveScreenShot(self):
        print('Disabled screenshot functionality')
